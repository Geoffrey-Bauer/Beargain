    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu rounded-4">
        <?php if ($auth::isAuth()) : ?>
          ...
          <li>
            <a href="/user/list-order/<?= \Core\Session\Session::get(\Core\Session\Session::USER)->id ?>" class="dropdown-item li-custom">Gérer mes réservations</a>
          </li>
          <li>
            <a href="/user/my-annonce/<?= \Core\Session\Session::get(\Core\Session\Session::USER)->id ?>" class="dropdown-item li-custom">Mes Annonces</a>
          </li>
          <li>
            <hr class="dropdown-divider">
          </li>
          <li>
            <a href="/user/create-annonce/<?= \Core\Session\Session::get(\Core\Session\Session::USER)->id ?>" class="dropdown-item li-custom">Mettre mon logement sur Beargain</a>
          </li>
          <li>
            <a href="/" class="dropdown-item li-custom">Mode Voyageur</a>
          </li>
          <li>
