    ...
    <div class="d-flex justify-content-center">
      <div class="d-flex flex-row flex-wrap my-3 justify-content-center col-lg-10">
        <div class="alert alert-info" role="alert">
          Vous n'avez pas encore de réservation sur vos biens.
        </div>
      </div>
    </div>
  <?php else: ?>
        ...
        <div class="col-md-6 col-lg-3 mb-4">
          <div class="card shadow-sm h-100 rounded-5">
            <div class="card-body d-flex flex-column">
              ...
              <h6 class="card-subtitle mb-2 text-muted"><?= $row->logement->title ?> (<?= $row->logement->information->city ?>)</h6>
              ...
              <a href="/user/list-order/delete/<?= $row->id ?>" class="btn btn-danger mt-auto">Annuler la réservation</a>
            </div>
          </div>
        </div>
      <?php endforeach; ?>
